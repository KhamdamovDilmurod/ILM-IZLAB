...
import com.example.ilm_izlab.databinding.EduItemLayoutBinding
...
class TrainingCentersAdapter (val items: List<TrainingCentersModel>):
    RecyclerView.Adapter<TrainingCentersAdapter.ItemHolder>() {

    inner class ItemHolder(val binding: EduItemLayoutBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        return ItemHolder(
            EduItemLayoutBinding.inflate(
